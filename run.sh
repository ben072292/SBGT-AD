...
$SPARK_HOME/bin/spark-submit --class edu.cwru.bayesgrouptesting.tests.HybridCrossPruningTreeTest SC22-Final.jar 15 LatticeDilution 0.02 0.01 0.01 1 24 0 12 1e-5 $CPUS_PER_TASK
$SPARK_HOME/bin/spark-submit --class edu.cwru.bayesgrouptesting.tests.HybridCrossPruningTreeTest SC22-Final.jar 16 LatticeDilution 0.02 0.01 0.01 1 24 0 12 1e-5 $CPUS_PER_TASK
$SPARK_HOME/bin/spark-submit --class edu.cwru.bayesgrouptesting.tests.HybridCrossPruningTreeTest SC22-Final.jar 17 LatticeDilution 0.02 0.01 0.01 1 24 0 12 1e-5 $CPUS_PER_TASK
$SPARK_HOME/bin/spark-submit --class edu.cwru.bayesgrouptesting.tests.HybridCrossPruningTreeTest SC22-Final.jar 18 LatticeDilution 0.02 0.01 0.01 1 24 0 12 1e-5 $CPUS_PER_TASK
$SPARK_HOME/bin/spark-submit --class edu.cwru.bayesgrouptesting.tests.HybridCrossPruningTreeTest SC22-Final.jar 19 LatticeDilution 0.02 0.01 0.01 1 24 0 12 1e-5 $CPUS_PER_TASK
$SPARK_HOME/bin/spark-submit --class edu.cwru.bayesgrouptesting.tests.HybridCrossPruningTreeTest SC22-Final.jar 20 LatticeDilution 0.02 0.01 0.01 1 24 0 12 1e-5 $CPUS_PER_TASK
$SPARK_HOME/bin/spark-submit --class edu.cwru.bayesgrouptesting.tests.HybridCrossPruningTreeTest SC22-Final.jar 21 LatticeDilution 0.02 0.01 0.01 1 24 0 12 1e-5 $CPUS_PER_TASK
$SPARK_HOME/bin/spark-submit --class edu.cwru.bayesgrouptesting.tests.HybridCrossPruningTreeTest SC22-Final.jar 22 LatticeDilution 0.02 0.01 0.01 1 24 0 12 1e-5 $CPUS_PER_TASK
$SPARK_HOME/bin/spark-submit --class edu.cwru.bayesgrouptesting.tests.HybridCrossPruningTreeTest SC22-Final.jar 23 LatticeDilution 0.02 0.01 0.01 1 24 0 12 1e-5 $CPUS_PER_TASK
$SPARK_HOME/bin/spark-submit --class edu.cwru.bayesgrouptesting.tests.HybridCrossPruningTreeTest SC22-Final.jar 24 LatticeDilution 0.02 0.01 0.01 1 24 0 12 1e-5 $CPUS_PER_TASK
$SPARK_HOME/bin/spark-submit --class edu.cwru.bayesgrouptesting.tests.HybridCrossPruningTreeTest SC22-Final.jar 25 LatticeDilution 0.02 0.01 0.01 1 24 0 12 1e-5 $CPUS_PER_TASK
...
$SPARK_HOME/bin/spark-submit --class edu.cwru.bayesgrouptesting.tests.SingleTreeTest SC22-Final.jar 15 LatticeDilution 0.02 0.01 0.01 1 24 $CPUS_PER_TASK
$SPARK_HOME/bin/spark-submit --class edu.cwru.bayesgrouptesting.tests.SingleTreeTest SC22-Final.jar 16 LatticeDilution 0.02 0.01 0.01 1 24 $CPUS_PER_TASK
$SPARK_HOME/bin/spark-submit --class edu.cwru.bayesgrouptesting.tests.SingleTreeTest SC22-Final.jar 17 LatticeDilution 0.02 0.01 0.01 1 24 $CPUS_PER_TASK
$SPARK_HOME/bin/spark-submit --class edu.cwru.bayesgrouptesting.tests.SingleTreeTest SC22-Final.jar 18 LatticeDilution 0.02 0.01 0.01 1 24 $CPUS_PER_TASK
$SPARK_HOME/bin/spark-submit --class edu.cwru.bayesgrouptesting.tests.SingleTreeTest SC22-Final.jar 19 LatticeDilution 0.02 0.01 0.01 1 24 $CPUS_PER_TASK
$SPARK_HOME/bin/spark-submit --class edu.cwru.bayesgrouptesting.tests.SingleTreeTest SC22-Final.jar 20 LatticeDilution 0.02 0.01 0.01 1 24 $CPUS_PER_TASK
$SPARK_HOME/bin/spark-submit --class edu.cwru.bayesgrouptesting.tests.SingleTreeTest SC22-Final.jar 21 LatticeDilution 0.02 0.01 0.01 1 24 $CPUS_PER_TASK
$SPARK_HOME/bin/spark-submit --class edu.cwru.bayesgrouptesting.tests.SingleTreeTest SC22-Final.jar 22 LatticeDilution 0.02 0.01 0.01 1 24 $CPUS_PER_TASK
$SPARK_HOME/bin/spark-submit --class edu.cwru.bayesgrouptesting.tests.SingleTreeTest SC22-Final.jar 23 LatticeDilution 0.02 0.01 0.01 1 24 $CPUS_PER_TASK


$SPARK_HOME/bin/spark-submit --class edu.cwru.bayesgrouptesting.tests.MultiTreeTest SC22-Final.jar 10 LatticeDilution 0.02 0.01 0.01 1 24
$SPARK_HOME/bin/spark-submit --class edu.cwru.bayesgrouptesting.tests.MultiTreeTest SC22-Final.jar 11 LatticeDilution 0.02 0.01 0.01 1 24
