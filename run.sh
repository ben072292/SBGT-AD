...
$SPARK_HOME/bin/spark-submit --class edu.cwru.bayesgrouptesting.tests.HybridCrossPruningTreeTest SC22-OP8.jar 25 LatticeDilution 0.02 0.01 0.01 1 24 0 12 1e-4 $CPUS_PER_TASK
